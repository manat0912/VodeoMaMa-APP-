...
def get_default_model_paths():
    """
    Get default model paths based on platform and environment
    Returns paths that should be set by user or environment variables
    
    Returns:
        dict with base_model_path and unet_checkpoint_path
    """
...
def load_videomama_pipeline(device="cuda"):
    ...
    unet_checkpoint_path = paths['unet_checkpoint_path']
