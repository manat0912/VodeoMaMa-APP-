...
def load_videomama_pipeline_hf(base_model_path=None, unet_checkpoint_path=None, device="cuda"):
    """
    ...
    # Use provided paths or defaults, ensuring they are absolute
    if base_model_path is None:
        base_model_path = os.path.join(script_dir, "checkpoints", "stable-video-diffusion-img2vid-xt")
    
    if unet_checkpoint_path is None:
        unet_checkpoint_path = os.path.join(script_dir, "checkpoints", "videomama")
