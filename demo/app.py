...
# Add parent directories to path (cross-platform compatible)
...
from sam2_wrapper_hf import load_sam2_tracker_hf
from videomama_wrapper_hf import load_videomama_pipeline_hf, videomama
...
def initialize_models():
    ...
    # Load SAM2
    sam2_tracker = load_sam2_tracker_hf(device=device)
    
    # Load VideoMaMa
    videomama_pipeline = load_videomama_pipeline_hf(device=device)
